...
const validateLauncherCommand = isWindows
  ? "powershell -ExecutionPolicy Bypass -Command \"if (-not (Test-Path '{{path.resolve('app/run.ps1')}}')) { throw 'Audiobook Studio update cannot continue: app\\\\run.ps1 was not found. Run Reset, then Install again.' }\""
